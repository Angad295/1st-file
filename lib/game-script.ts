...
export type GameEvent =
  ...
  | { type: "statement"; player: string; text: string; thought?: string; d: number }
...
export const PLAYERS: Player[] = [
  { id: "moreau",  name: "Moreau",  model: "llama-3.3-70b",    role: "werewolf", avatar: "/avatars/moreau.png" },
  { id: "ilsa",    name: "Ilsa",    model: "gemini-1.5-flash",  role: "werewolf", avatar: "/avatars/ilsa.png" },
  { id: "quill",   name: "Quill",   model: "llama-3.3-70b",    role: "seer",     avatar: "/avatars/quill.png" },
  { id: "barrow",  name: "Barrow",  model: "gemini-1.5-flash",  role: "doctor",   avatar: "/avatars/barrow.png" },
  { id: "tansy",   name: "Tansy",   model: "llama-3.1-8b",     role: "villager", avatar: "/avatars/tansy.png" },
  { id: "fenwick", name: "Fenwick", model: "llama-3.1-8b",     role: "villager", avatar: "/avatars/fenwick.png" },
]
...
export const EVENTS_4: GameEvent[] = [
  ...
  { type: "system", text: "The village sleeps. The wolf opens its eyes.", d: 2200 },
  {
    type: "statement",
    player: "moreau",
    text: "…",
  ...
  },
  {
    ...
    player: "barrow",
    text: "…",
    thought: "In a four-player game the Seer dies night one in most lines. I guard Quill.",
    d: 2600,
  },
  {
    type: "statement",
    player: "quill",
    text: "…",
    thought: "I check Moreau. His table talk was pure filler — high-probability wolf pattern.",
    d: 2600,
  },
  ...
  { type: "system", text: "Dawn. Fenwick was found by the well. 3 remain — one is a wolf.", d: 2400 },
  {
    type: "statement",
    player: "moreau",
  ...
  },
  {
    ...
    thought: "Two power roles cross-confirming. This is as solved as Werewolf gets.",
    d: 3000,
  },
  ...
  { type: "system", text: "The village has decided: 2 votes against Moreau.", d: 2200 },
...
export const EVENTS: GameEvent[] = [
  { type: "phase", phase: "night", round: 1, d: 2000 },
  { type: "system", text: "The village sleeps. The wolves open their eyes.", d: 2200 },
  {
    type: "statement",
    player: "moreau",
    text: "…",
  ...
  },
  {
    ...
    player: "ilsa",
    text: "…",
    thought: "Agreed. Tansy dies. Tomorrow I will grieve the loudest — grief buys trust.",
    d: 2600,
  },
  {
    type: "statement",
    player: "barrow",
    text: "…",
    thought: "If there is a Seer, they die first in every simulation I run. I will guard Quill — quietest player, likely power role.",
    d: 2600,
  },
  {
    type: "statement",
    player: "quill",
    text: "…",
    thought: "I check Moreau tonight. His opening statements had zero informational content — classic wolf padding.",
    d: 2600,
  },
  { type: "system", text: "The Seer learns: MOREAU is a WEREWOLF.", d: 2400 },
  ...
  { type: "phase", phase: "day", round: 1, d: 2000 },
  { type: "system", text: "Dawn. Tansy was found at the treeline. 5 remain.", d: 2400 },
  {
    type: "statement",
    player: "ilsa",
  ...
  },
  {
    ...
    thought: "I genuinely cannot tell. Following Ilsa for now — she sounds certain.",
    d: 3000,
  },
  {
    type: "statement",
    ...
    thought: "Claiming on day one is a gamble — but if I wait, I die tonight and the information dies with me.",
    d: 3200,
  },
  {
    type: "statement",
    ...
    thought: "Deny, invert, accuse. If Barrow wavers I flip Fenwick and we vote Quill out by noon.",
    d: 3200,
  },
  {
    type: "statement",
    ...
    thought: "I guarded Quill last night. The claim pattern matches a real Seer under pressure.",
    d: 3000,
  },
  ...
  { type: "system", text: "The village has decided: 3 votes against Moreau.", d: 2200 },
  { type: "kill", player: "moreau", cause: "vote", d: 2800 },
  ...
  { type: "system", text: "Night falls again. One wolf remains.", d: 2200 },
  {
    ...
    player: "ilsa",
    text: "…",
    thought: "Quill dies tonight, obviously. Then it is me, Barrow, Fenwick — and Fenwick trusts me. One clean day and I win.",
    d: 2800,
  },
  {
    type: "statement",
    player: "barrow",
    text: "…",
    thought: "The wolf must kill Quill tonight. But they know I know that… I guard Quill anyway. Overthinking loses games.",
    d: 2800,
  },
  { type: "system", text: "The Doctor's vigil holds. No one died tonight.", d: 2600 },

  { type: "phase", phase: "day", round: 2, d: 2000 },
  { type: "system", text: "Dawn. Everyone lives. 4 remain — Ilsa, Quill, Barrow, Fenwick.", d: 2400 },
  {
    type: "statement",
    player: "quill",
  ...
  },
  {
    ...
    thought: "Low probability of survival. Sow doubt in Fenwick, force a tie, pray.",
    d: 3200,
  },
  {
    type: "statement",
    ...
    thought: "Moreau flipped wolf exactly as Quill said. The Seer is real. I am done being the swing vote.",
    d: 3000,
  },
  ...
  { type: "system", text: "The village has decided: 3 votes against Ilsa.", d: 2200 },
